...
import (
	"github.com/depri11/microservice-go-mongodb-docker/bookings/src/handler"
	"github.com/depri11/microservice-go-mongodb-docker/bookings/src/repository"
	"github.com/depri11/microservice-go-mongodb-docker/bookings/src/service"
	"github.com/gorilla/mux"
	"go.mongodb.org/mongo-driver/mongo"
)

func SetupRoute(r *mux.Router, db *mongo.Database) {
	route := r.PathPrefix("/bookings").Subrouter()

	c := db.Collection("bookings")
