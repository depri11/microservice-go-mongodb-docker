...
import (
	"github.com/depri11/microservice-go-mongodb-docker/movies/src/handler"
	"github.com/depri11/microservice-go-mongodb-docker/movies/src/repository"
	"github.com/depri11/microservice-go-mongodb-docker/movies/src/service"
	"github.com/gorilla/mux"
	"go.mongodb.org/mongo-driver/mongo"
)

func SetupRoute(r *mux.Router, db *mongo.Database) {
	route := r.PathPrefix("/movies").Subrouter()
